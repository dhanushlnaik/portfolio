...
export const projects: Project[] = [
  {
    title: 'StrayMate',
    description: 'Platform to find loving homes for stray animals.',
  ...
  {
    title: 'EIPs Insights',
    description: 'Blockchain insights platform (dev & prod branches).',
    ...
    live: '#',
    details: false,
    projectDetailsPageSlug: '/projects/eips-insights',
    isWorking: false,
  },
  {
    title: 'DeliverZip',
    description: 'Regional delivery platform using buses/trains (hackathon project).',
  ...
  },
  {
    ...
    github: 'https://github.com/dhanushlnaik/syncify',
  ...
  },
  {
    ...
    link: 'https://quest.dhanushlnaik.tech/',
    technologies: [
      { name: 'Next.js', icon: <NextJs key="nextjs" /> },
      { name: 'TypeScript', icon: <TypeScript key="typescript" /> },
      { name: 'Vercel', icon: <Vercel key="vercel" /> },
    ...
    github: 'https://github.com/dhanushlnaik/the-quest',
    live: 'https://quest.dhanushlnaik.tech/',
    details: true,
  ...
  },
  {
    ...
    link: 'https://fest-x.dhanushlnaik.tech/',
    technologies: [
      { name: 'Next.js', icon: <NextJs key="nextjs" /> },
      { name: 'TypeScript', icon: <TypeScript key="typescript" /> },
      { name: 'MongoDB', icon: <MongoDB key="mongodb" /> },
    ...
    github: 'https://github.com/dhanushlnaik/fest-x',
    live: 'https://fest-x.dhanushlnaik.tech/',
    details: true,
  ...
  },
  {
    ...
    link: 'https://chillguy.dhanushlnaik.tech',
    technologies: [
      { name: 'React', icon: <ReactIcon key="react" /> },
    ...
    github: 'https://github.com/dhanushlnaik/chill-guy',
    live: 'https://chillguy.dhanushlnaik.tech',
    details: true,
    projectDetailsPageSlug: '/projects/chill-guy',
    isWorking: true,
  },
  {
    title: "Dhanush's Space",
    description:
    ...
    link: 'https://blog.dhanushlnaik.tech/',
    technologies: [
      { name: 'Next.js', icon: <NextJs key="nextjs" /> },
      { name: 'TypeScript', icon: <TypeScript key="typescript" /> },
      { name: 'React', icon: <ReactIcon key="react" /> },
    ...
    live: 'https://blog.dhanushlnaik.tech/',
    details: true,
  ...
  },
  {
    ...
    link: 'https://intent-js.dhanushlnaik.tech',
    technologies: [
      { name: 'Next.js', icon: <NextJs key="nextjs" /> },
      { name: 'TypeScript', icon: <TypeScript key="typescript" /> },
      { name: 'React', icon: <ReactIcon key="react" /> },
    ...
    github: 'https://github.com/dhanushlnaik/intent-js',
    live: 'https://intent-js.dhanushlnaik.tech',
    details: true,
  ...
  },
  {
    ...
    link: 'https://moonstone.dhanushlnaik.tech/',
    technologies: [
      { name: 'Next.js', icon: <NextJs key="nextjs" /> },
      { name: 'TypeScript', icon: <TypeScript key="typescript" /> },
      { name: 'React', icon: <ReactIcon key="react" /> },
    ...
    github: 'https://github.com/dhanushlnaik/moonstone-fest',
    live: 'https://moonstone.dhanushlnaik.tech/',
    details: true,
  ...
  },
  {
    ...
    link: 'https://valorant.dhanushlnaik.tech',
    technologies: [
      { name: 'TypeScript', icon: <TypeScript key="typescript" /> },
      { name: 'React', icon: <ReactIcon key="react" /> },
    ],
    github: 'https://github.com/dhanushlnaik/valorant-remastered',
    live: 'https://valorant.dhanushlnaik.tech',
    details: true,
  ...
  },
  {
    ...
    link: 'https://that-startup.dhanushlnaik.tech/',
    technologies: [
      { name: 'Next.js', icon: <NextJs key="nextjs" /> },
      { name: 'TypeScript', icon: <TypeScript key="typescript" /> },
      { name: 'Tailwind CSS', icon: <TailwindCss key="tailwindcss" /> },
    ...
    github: 'https://github.com/dhanushlnaik/that-startup',
    live: 'https://that-startup.dhanushlnaik.tech/',
    details: true,
